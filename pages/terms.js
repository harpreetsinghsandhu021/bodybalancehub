...
const terms = () => {
  return (
    <main className="main--teeth--blog algn--left">
      <h1>Terms of Service Agreement</h1>
      <p>This Agreement was last modified on March 9, 2022.</p>
      <p>
        Please read these Terms of Service (&ldquo;Agreement&rdquo;,
        &ldquo;Terms of Service&rdquo;) carefully before using this website
        (&ldquo;the Site&rdquo;). This Agreement sets forth the legally binding
        terms and conditions for your use of the Site.
      </p>
      <p>
        ...
        materials to the Site, you agree to be bound by these Terms of Service.
      ...
      <p>
        The Site has no control over, and assumes no responsibility for, the
      ...
      <p>
        ...
        with the laws of California, United States, without giving effect to any
